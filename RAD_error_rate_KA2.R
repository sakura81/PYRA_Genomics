library("adegenet", lib.loc="~/R/win-library/3.3")


LociAllele_error <- function(genlight_obj, param){ 
...
#Example commands:
#MGW_r5m5 <- read.PLINK("MGW_r5m5.raw", parallel=FALSE)
#LociAllele_error(MGW_r5m5, "r5m5")